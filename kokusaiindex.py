...
import scraping.kokusai as s,kanjou,Johnny
...
if tw.api is not None:
  #リストの中から最新3ツイートを取得(リツイートを含む)
    for status in tw.api.list_timeline(list_id=1404674012442095618, count=3, include_rts=1):
      #リツイートされたものか判定
...
<body>
<header><a href= "index.py" ><img src="NewsFriend.png"width="16%" height="16%" ></a></header>
